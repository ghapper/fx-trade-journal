    ...
    (async () => {
      ...
      chart = createChart(container, {
        ...
        crosshair: {
          ...
          vertLine: { color: "#3a3a5e", style: 1 },
          horzLine: { color: "#3a3a5e", style: 1 },
        },
        rightPriceScale: {
          borderColor: "#1e1e2e",
        ...
        handleScroll: { mouseWheel: true, pressedMouseMove: true, pinch: true },
    ...
    if (trade.fills.length > 0 && chartRef.current) {
      ...
      if (entryFills.length > 0 && exitFills.length > 0) {
        ...
        const exitTs = Math.floor(
          new Date(exitFills[exitFills.length - 1].datetime).getTime() / 1000
        );
